...
public class JobTitlesController {
    ...
    public ResponseEntity<ResponseDTO<List<JobTitlesDTO>>> fetchAllJobTitles() {
        return ResponseEntity.ok(ResponseDTO.success(CorpConnectConstants.JobTitles.JOB_TITLE_LIST_FOUND, jobTitlesService.getDTOList(jobTitlesService.getAllJobTitles())));
    }
    ...
    public ResponseEntity<ResponseDTO<List<JobTitlesDTO>>> fetchJobTitleByJobTitleId(@PathVariable("job-title-id") Long jobTitleId) {
        return ResponseEntity.ok(ResponseDTO.success(CorpConnectConstants.JobTitles.JOB_TITLE_FOUND, jobTitlesService.getDTOList(jobTitlesService.getJobTitlesById(jobTitleId))));
    }
